...
-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('SINGLE_CHOICE', 'MULTIPLE_CHOICE', 'FILL_BLANK', 'PROGRAMMING');

-- CreateEnum
CREATE TYPE "SubmissionStatus" AS ENUM ('PENDING', 'AUTO_GRADED', 'COMPLETED');

-- CreateEnum
CREATE TYPE "GradingType" AS ENUM ('AUTO_STRICT', 'MANUAL_REVIEW');
...
CREATE TABLE "Question" (
    ...
    "gradingType" "GradingType" NOT NULL DEFAULT 'AUTO_STRICT',
